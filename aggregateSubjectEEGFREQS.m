function aggregateSubjectEEGFREQS(subjectList)
    ...
    for subject = 1:size(list, 1)
        for iTrial = 1:length(trials)
            ...
            datasetfile = fullfile(ProjectConstants.ProjectRoot, ...
    ...
    save(fullfile(ProjectConstants.ProjectRoot, 'EEGFREQS_datasets.mat'), ...
         'EEGFREQS_full', ...
         '-v7.3');
    save(fullfile(ProjectConstants.ProjectRoot, 'EEGFREQS_sections.mat'), ...
         'EEGFREQS_sections', ...
         '-v7.3');
end
